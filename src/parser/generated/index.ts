      ...
      var peg$FAILED = {},
        ...
        peg$c2 = function (body) {
          const items = Array.isArray(body)
            ? body
                .map((i) => (i && i.kind ? i : void 0))
                .filter((i) => void 0 !== i)
            : body;
          return 1 === items.length ? items[0] : items;
        },
        ...
        peg$c13 = function (newline) {
          return newline;
        },
        peg$c14 = function (newlines) {
        ...
        peg$c22 = function (token, anchor, description) {
          return { anchor: anchor, description: description };
        },
        peg$c23 = function (token, node) {
          return null;
        },
        peg$c24 = function (token, node) {
          return toSpwItem({
            token: token,
            position: 'open',
            label: node.anchor,
            description: node.description,
            kind: 'domain_objective',
          });
        },
        peg$c25 = function (tok) {
          return toSpwItem({
            token: tok,
            position: 'open',
            kind: 'domain_objective',
        ...
        peg$c29 = function (token, node) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
            kind: 'domain_subjective',
          });
        },
        peg$c30 = function (node, token) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
        ...
        peg$c34 = function (open) {
          return null;
        },
        peg$c35 = function (open, underscore) {
          return underscore;
        },
        peg$c36 = function (open, close) {
          return { open: open, close: close };
        },
        peg$c37 = function (open, body, close) {
          return { open: open, body: body, close: close };
        },
        peg$c38 = function (container) {
          return toSpwItem({
            kind: 'domain',
            open: container.open,
            body: container.body,
        ...
        peg$c42 = function (token, node) {
          return toSpwItem({
            token: token,
            position: 'open',
            label: node.anchor,
            description: node.description,
            kind: 'essence_objective',
          });
        },
        peg$c43 = function (tok) {
          return toSpwItem({
            token: tok,
            position: 'open',
            kind: 'essence_objective',
        ...
        peg$c47 = function (token, node) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
            kind: 'essence_subjective',
          });
        },
        peg$c48 = function (node, token) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
        ...
        peg$c56 = function (token, node) {
          return toSpwItem({
            token: token,
            position: 'open',
            label: node.anchor,
            description: node.description,
            kind: 'concept_objective',
          });
        },
        peg$c57 = function (tok) {
          return toSpwItem({
            token: tok,
            position: 'open',
            kind: 'concept_objective',
        ...
        peg$c61 = function (token, node) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
            kind: 'concept_subjective',
          });
        },
        peg$c62 = function (node, token) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
        ...
        peg$c75 = function (token, node) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
            kind: 'group_subjective',
          });
        },
        peg$c76 = function (node, token) {
          return toSpwItem({
            token: token,
            position: 'close',
            label: node,
        ...
        peg$c89 = function (head, line, chars) {
        ...
        peg$c100 = function (phrase) {
          function makeArray(r) {
            return Array.isArray(r) ? r : [r];
          }
          const _phrase = phrase,
            p = _phrase.reduce((r, e) => [...r, ...makeArray(e)], []);
          return toSpwItem({ kind: 'phrase', body: p });
        },
        ...
        peg$c114 = function (node, spec) {
          return null;
        },
        peg$c115 = function (node, spec, container) {
          return container;
        },
        peg$c116 = function (node, spec, description) {
          return (
            'undefined' != typeof spec &&
              ((node.key += spec.map((e) => e.key)), (node.spec = spec)),
            node
          );
        },
        ...
        peg$c144 = function (_operatorComponents) {
        ...
        peg$c148 = function (_operatorComponents) {
        ...
        peg$c152 = function (_operatorComponents) {
        ...
        peg$c156 = function (_operatorComponents) {
        ...
        peg$c166 = function (_operatorComponents) {
        ...
        peg$c170 = function (_operatorComponents) {
        ...
        peg$c174 = function (_operatorComponents) {
        ...
        peg$c178 = function (_operatorComponents) {
        ...
        peg$c181 = function (source) {
          return null;
        },
        peg$c182 = function (source, atom, spec) {
          return toSpwItem({ kind: 'lens', atom: atom, spec: spec });
        },
        peg$c183 = function (source, atom) {
          return { atom: atom };
        },
        peg$c184 = function (source, lens) {
          return null;
        },
        peg$c185 = function (source, lens, target) {
          return toSpwItem({
            kind: 'perspective_expression',
            source: source,
            lens: lens,
            target: target,
          });
        ...
        peg$c187 = function (head) {
          return null;
        },
        peg$c188 = function (head, operator) {
          return null;
        },
        peg$c189 = function (head, operator, item) {
          return toSpwItem({
            kind: 'strand_tail',
            operator: operator,
            item: item,
