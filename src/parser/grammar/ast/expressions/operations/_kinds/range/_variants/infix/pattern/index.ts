import { headComponent } from '@grammar/ast/expressions/operations/_kinds/range/_variants/infix/pattern/head';
import { tailComponent } from '@grammar/ast/expressions/operations/_kinds/range/_variants/infix/pattern/tail';
