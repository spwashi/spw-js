import { headComponent } from '@grammar/ast/expressions/operations/aggregation/_variants/infix/pattern/head';
import { tailComponent } from '@grammar/ast/expressions/operations/aggregation/_variants/infix/pattern/tail';
