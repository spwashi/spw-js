import { headComponent } from '@grammar/ast/expressions/operations/transformation/_variants/infix/pattern/head';
import { tailComponent } from '@grammar/ast/expressions/operations/transformation/_variants/infix/pattern/tail';
